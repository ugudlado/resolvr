#!/bin/bash
# SessionStart: Load branch, spec, tasks, and git status as context
set -euo pipefail
...
if [[ "$(pwd)" == */code/feature_worktrees/* ]]; then
  ...
  SPEC_FILE="$WORKTREE_ROOT/specs/active/spec.md"
  TASKS_FILE="$WORKTREE_ROOT/specs/active/tasks.md"
