...
- [x] T001: Add task progress parsing to features endpoint [P]
...
- [x] T002: Add open thread count to features endpoint [P]
...
- [x] T003: Add last activity timestamp to features endpoint [P]
...
- [x] T004: Add files changed count to features endpoint [P]
...
- [x] T005: Extend FeatureInfo type with new fields (depends: T001, T002, T003, T004)
...
- [x] T006: Create relative time formatter utility (depends: T005)
...
- [x] T007: Create PipelineDots component (depends: T005) [P]
...
- [x] T008: Create SkeletonCard component (depends: T005) [P]
...
- [x] T009: Create EmptyState component (depends: T005) [P]
...
- [x] T010: Rewrite FeatureCard with enhanced layout (depends: T006, T007)
...
- [x] T011: Enhance Dashboard with sort, skeleton, empty state, search count (depends: T008, T009, T010)
...
- [x] T012: Delete old PipelineProgress component (depends: T010)
...
- [x] T013: Visual verification across all states (depends: T011, T012)
...
- [x] T014: Type check and lint (depends: T013)
