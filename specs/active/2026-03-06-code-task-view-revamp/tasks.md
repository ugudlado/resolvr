...
- [x] T005: Restyle file sidebar with Notion dark theme (depends: T001)
...
- [x] T006: Create DiffInlineThread component (depends: T005)
...
- [x] T007: Wire inline threads into diff via extendData (depends: T006)
...
- [x] T008: Create DiffThreadNav component (depends: T006, T007)
...
- [x] T009: Replace CodeThreadsPanel with DiffThreadNav in ReviewPage (depends: T007, T008)
...
- [x] T010: Apply Notion dark theme to diff file header and mode toggle (depends: T005)
...
- [x] T011: Integrate verdict buttons into FeatureNavBar for code review (depends: T010)
...
- [x] T012: Apply Notion dark to ReviewPage overall layout and background (depends: T009, T011)
...
- [x] T013: Create TaskRow component (depends: T003, T004)
...
- [x] T014: Create PhaseSection component (depends: T013)
...
- [x] T015: Create TaskTimeline component (depends: T014)
...
- [x] T016: Replace TaskBoard with TaskTimeline in TasksPage (depends: T015)
